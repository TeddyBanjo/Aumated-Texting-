...
GOOD_MORNING_QUOTES = [
    ...
    "Good Morning Lovely! Hope you slept well x",
    "Hope you have a great day today, my love!",
    "Love you so much, I know you will a fantastic day. I can't wait to see you later. "
]
...
schedule.every().day.at("07.30").do(send_message, GOOD_MORNING_QUOTES)
